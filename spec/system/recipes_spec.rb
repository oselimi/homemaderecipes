...
RSpec.describe 'Recipes' do
  ...
  let!(:recipe) { create(:recipe, title: 'First title', description: 'description of recipe', user: user) }
  let!(:other_recipe) { create(:recipe, title: 'Second title', description: 'description of secont recipe', user: other) }
  ...
  describe 'when not logged in' do
    ...
    it 'shows all recipes without logged in but other user created' do
