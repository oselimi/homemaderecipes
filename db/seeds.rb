...
5.times do
  ...
  description = "Crunchy, flaky, and cheesy. What's not to love? These cheese straws are studded with cheddar,
                green onions, and sesame seeds for the most flavor-packed cheese straws we've ever had. 
                Using store-bought puff pastry makes them extremely easy to pull together for a party! 
